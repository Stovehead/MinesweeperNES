...
push_tile_buffer_to_stack: ; Clobbers $00, $01, $02, $03, $04, A, X, Y
    ...
    and #%00010000
    bne :+
    lda scratch + 2 ; Bottom right
    and #%11000000
    sta scratch + 2
    lda #%00111111
    sta scratch + 3
    jmp @after_determine_attribute
    :
    lda scratch + 2 ; Top right
    and #%00001100
    sta scratch + 2
    lda #%11110011
    sta scratch + 3
    ...
    jmp @after_determine_attribute
    :
    lda scratch + 2 ; Top left
    and #%00000011
    sta scratch + 2
    lda #%11111100
    sta scratch + 3
    @after_determine_attribute:
    lda scratch + 1
    and scratch + 3
    ora scratch + 2
    sta $0100, x
...
TilePalettes:
    ...
    .byte $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA
    .byte $AA, $FF, $AA, $55, $FF, $55, $FF, $55, $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF
